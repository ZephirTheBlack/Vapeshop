...
<body>
    ...
    require_once 'functions/products_functions.php';
    ?>
    <div class="container shadow p-3 mt-4 mb-4 rounded">
        <center>
            <h2>Echa un vistazo a nuestros productos y realiza tu compra</h2>
        </center>
